...
def non_proportional_algorithm(request):
    ...
    pattern_treated_unfairly_lowerbound, num_patterns_visited, time = GraphTraverseNonProportional(ranked_data,
                                                                                                   attributes, thc,
                                                                                                   Lowerbounds, k_min,
                                                                                                   k_max, 60 * 10)
...
def proportional_algorithm(request):
    ...
    pattern_treated_unfairly_lowerbound, num_patterns_visited, time = GraphTraverseProportional(ranked_data,  attributes, thc, alpha, k_min,
                                                                                                   k_max, 60 * 10)
