...
output_path = r'../../../../OutputData/LowAccDetection/AdultDataset/thc_optimized.txt'
...
plt.legend()
plt.savefig("../../../../OutputData/LowAccDetection/AdultDataset/thc_time_optimized.png")
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.18)
plt.legend()
plt.savefig("../../../../OutputData/LowAccDetection/AdultDataset/thc_calculations_optimized.png")
plt.show()
