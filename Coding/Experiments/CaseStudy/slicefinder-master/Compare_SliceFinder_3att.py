...
compas_data = compas_data[['sex', 'race', 'age_cat', 'ground_truth']]
...
pickle.dump(encoders, open("compas_3att.pkl", "wb"), protocol=2)
...
time1 = time.time()
recommendations = sf.find_slice(k=50, degree=3, max_workers=4)
time2 = time.time()

output_path = r'Compare_SliceFinder_3att.txt'
